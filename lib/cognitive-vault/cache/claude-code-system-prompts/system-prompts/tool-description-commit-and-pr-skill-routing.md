...
description: "Requires commits and pull requests to use their dedicated skills while defining narrow exceptions for raw git commit and gh pr create commands"
ccVersion: "2.1.269"
variables:
  - "COMMIT_SKILL_NAME"
