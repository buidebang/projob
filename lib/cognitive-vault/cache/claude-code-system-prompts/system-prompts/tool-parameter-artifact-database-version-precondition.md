...
description: "Defines the optional if_version precondition for Artifact database writes, directing Claude to supply the last-read document version and pin batch entries individually"
ccVersion: "2.1.267"
-->
