...
// There is still the original block underneath that synthesis the result and sends a NextResponse.json.
// Let's replace the rest of the try block up to the catch block since we are returning a stream directly.
